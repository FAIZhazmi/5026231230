...
@section('content')
    ...
    <script>
        ...
        function calculateTotal() {
            let jumlah = document.getElementById('Total_Jumlah_x_Harga').value;
            let harga = document.getElementById('Harga_per_item').value;
            let total = Total_Jumlah_x_Harga * Harga_per_item;
        ...
        document.getElementById('Total_Jumlah_x_Harga').addEventListener('input', calculateTotal);
        document.getElementById('Harga_per_item').addEventListener('input', calculateTotal);
    </script>
@endsection
